...
namespace DeadManZone.Core.Tags
{
    ...
    {
        private static readonly IReadOnlyDictionary<string, TagDefinition> Catalog = BuildCatalog();
        ...
        private static IReadOnlyDictionary<string, TagDefinition> BuildCatalog()
        {
            var catalog = new Dictionary<string, TagDefinition>(StringComparer.Ordinal)
            {
                // Primary
