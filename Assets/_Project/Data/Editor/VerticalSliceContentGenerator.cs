        ...
        private static EnemyTemplateSO[] CreateEnemies(PieceDefinitionSO[] pieces)
        {
            ...
            return new[]
            {
                ...
                SaveEnemy(5, "Siege Crawler", "Boss",
                    new[] { Placement(byId["diesel_walker"], 7, 4), Placement(byId["mg_team"], 5, 4), Placement(byId["field_gun_nest"], 0, 0) }),
                SaveEnemy(6, "Reinforced Line", "Infantry",
                    new[] { Placement(byId["mg_team"], 6, 4), Placement(byId["rifle_squad"], 8, 4), Placement(byId["rifle_squad"], 4, 4) }),
                ...
                SaveEnemy(10, "Final Assault", "Boss",
                    new[] { Placement(byId["diesel_walker"], 7, 4), Placement(byId["mobile_artillery"], 6, 3), Placement(byId["mg_team"], 5, 4), Placement(byId["mortar_crew"], 4, 3) })
            };
        }
