            ...
            if (tagChipContainer == null)
{
        ...
        private void BindAttackType(PieceCardViewModel model)
        {
            ...
            attackTypeText.text = $"Attack Type: {FormatAttackType(model.AttackType)}{tooltip}";
        }
        ...
        private void BindArmorType(PieceCardViewModel model)
        {
            ...
            armorTypeText.text = $"Armor Type: {FormatArmor(model.ArmorType)}{tooltip}";
        }
        ...
        private void BindSalvageContext(PieceCardViewModel model)
        {
            ...
            if (hasContext)
                salvageContextText.color = theme != null ? theme.accentColor : Color.yellow;
        }
