Code Monkey Toolkit - Version 1.0.3
=============================
...
---------
## [1.0.4] - 2026-04-15
- Added Tool: Transition Effect
- Added Tool: Shader Blur 2D
- Added Tool: Shader Dissolve 2D
- Added Tool: Shader Outline 2D
- Added Tool: Shader Pixelate 2D
- Added Tool: Shader Tint 2D

## [1.0.3] - 2026-04-13
- Updated all tools to work with either Input Manager or Input System
- Updated WebRequests to support custom headers
- Updated Question Dialog to have an option with only a single OK button
- Added Tool: Drag Window
- Added Tool: OpenAI API
- Added Tool: Scene Loading System
- Added Tool: Tick System
- Added Tool: Virtual Cursor
